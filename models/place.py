#!/usr/bin/python3
""" Module for HBNB project and a place to stay """
...
class Place(BaseModel, Base):
    ...
    if storage_type == 'db':
        ...
        def amenities(self, obj):
            ''' The method for adding an Amenity.id to the
                attribute amenity_ids. It accepts only Amenity
                objects
            '''
            if obj is not None:
