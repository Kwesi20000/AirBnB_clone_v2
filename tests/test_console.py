#!/usr/bin/python3
"""Module for the test for console"""
import unittest
...
class TestConsole(unittest.TestCase):
    ...
    @classmethod
    def teardown(cls):
        """when the test end, this will tear it down"""
        del cls.consol

    def tearDown(self):
        """This removes temporary file (file.json) created as a result"""
        try:
            os.remove("file.json")
        except Exception:
            pass
    ...
    def test_create(self):
        """This Test create command input"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_update(self):
        """This test update command input"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_all(self):
        """this test alternate all command input"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_z_show(self):
        """This test alternate show command input"""
        with patch('sys.stdout', new=StringIO()) as f:
    ...
    def test_destroy(self):
        """This test alternate destroy command input"""
        with patch('sys.stdout', new=StringIO()) as f:
